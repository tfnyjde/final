...
class Ninja():      #class
    ...
    occupation = "Shinobi"    #applies to all ninja
    ...
    def learn_jutsu(self):
        jutsu_list = ["Chidori", "Rasengan", "Healing Jutsu", "Sharingan", "Kyubi Chakra"]
        new_jutsu = random.choice(jutsu_list)
        self.jutsu.append(new_jutsu)
        print(self.name + " learned " + new_jutsu)
